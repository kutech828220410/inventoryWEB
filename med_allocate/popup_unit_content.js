...
async function set_ppuc_med_info(temp_guid) {
    ...
    post_result_data.forEach(element => {
        if(element.GUID == temp_guid) {
            ...
            ppuc_h_title.innerHTML = element.destinationStoreType;
            ...
            ppuc_sys_qty.innerHTML = element.actualIssuedQuantity;
            ppuc_req_qty.innerHTML = element.issuedQuantity;
            ppucmi_name.innerHTML = element.name;
            if(element.cht_name) {
                ppucmi_cht_name.innerHTML = element.cht_name;
            } else {
                ppucmi_cht_name.innerHTML = "無";
            }
            pp_calculate_input.value = +element.actualIssuedQuantity;
            pp_calculate_input_display.innerHTML = element.actualIssuedQuantity;
