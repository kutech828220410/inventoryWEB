...
function get_Lock()
{
  ...
  My_Div.Init(lock_div, 'lock_div','lock_div', '240px', '50px', 'gray');
  ...
  lock_div.style.top= "0px";
  lock_div.style.borderRadius = "10px";
  lock_div.style.boxShadow = "4px 4px 15px rgba(0, 0, 0, 0.9)";
  lock_div.style.marginTop = "10px";

  const lock_svg = Get_lock_SVG("80%", "80%", "80%","80%","","none");
  My_Div.Init(lock_svg, 'lock_svg','lock_svg', '30%', '100%', '');
