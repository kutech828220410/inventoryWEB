...
function get_pharmacy()
{
  ...
  pharmacy_text_div.style.backgroundImage = 'linear-gradient(to right, #000046, #000046)';
  ...
  pharmacy_text_eng_div.style.backgroundImage = 'linear-gradient(to right, #000046, #000046)';
...
function get_storehouse()
{
  ...
  storehouse_text_div.style.backgroundImage = 'linear-gradient(to right, #000046, #000046)';
  ...
  My_Div.Set_Text( storehouse_text_eng_div ,"Storehouse" , TextAlignEnum.CENTER , "22px", true,"","");
   storehouse_text_eng_div.style.backgroundImage = 'linear-gradient(to right, #000046, #000046)';
...
function get_ward()
{
  ...
  ward_div.style.borderRadius = "5px";
  ...
  ward_text_div.style.backgroundImage = 'linear-gradient(to right, #000046, #000046)';
  ...
  My_Div.Set_Text( ward_text_eng_div ,"Nursing Station" , TextAlignEnum.CENTER , "20px", true,"","");
   ward_text_eng_div.style.backgroundImage = 'linear-gradient(to right, #000046, #000046)';
