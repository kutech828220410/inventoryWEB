...
async function get_by_requestTime(str_date, end_date) {
    ...
    console.log(data);
    console.log(`${api_ip}api/drugStotreDistribution/get_by_addedTime`);
    let temp_data = await fetch(`${api_ip}api/drugStotreDistribution/get_by_addedTime`, {
        method: "POST",
        headers: {
...
async function dsd_update_by_guid(data) {
    let post_data =   {
        "ServerName" : "ds01",
        "ServerType" : "藥庫",
        "Data": [data],
    ...
    console.log(`${api_ip}api/drugStotreDistribution/update_by_guid`);
    let temp_data = await fetch(`${api_ip}api/drugStotreDistribution/update_by_guid`, {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
        },
