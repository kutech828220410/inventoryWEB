...
async function verifyUser(event) 
{
    ...
    {
        const greeting = `${session_login.Data.Name} 即將進入盤點作業。`;
        alert(greeting);
        ...
        window.location.href = "departmentselect.html"; 
    }
    return false; // 防止表單提交
}
async function showConfirm()
{
    ...
    window.location.href = "inventory/departmentselect.html"; // 跳轉到 frontpage.html 頁面
