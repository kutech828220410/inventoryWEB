...
function creat_row_div(_index , item) 
{
    ...
    My_Div.Set_Text(formnnum_div ,`編號 : ${_index + 1}` , TextAlignEnum.LEFT , "16px", true ,"微軟正黑體","#F6F7F7");
    formnnum_div.setAttribute("_index",_index);
    formnnum_div.style.background ="#6B6B63";
...
async function downloadbtn_Click(event)
{
  ...
  console.log(`${api_ip}api/inspection/download_excel_by_IC_SN`);
  Set_main_div_enable(true);
  await download_excel_by_IC_SN(IC_SN, api_ip);
